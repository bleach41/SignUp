...
export function ThemeProvider({
  ...
  useEffect(() => {
    ...
    const wasDynamicTheme = localStorage.getItem(`${storageKey}-dynamic`) === "true"
  ...
  useEffect(() => {
    ...
    const previousThemes = ["lucky-wolf", "red-casino", "green-fortune", "purple-royale", "gold-rush", "dynamic-theme"]
