  ...
  return (
    <header className="flex h-16 w-full items-center justify-between border-b border-border bg-background px-4">
      <div className="flex items-center gap-4">
        <Button variant="ghost" size="icon" className="text-primary-foreground" onClick={toggleSidebar}>
          <Menu className="h-5 w-5" />
        </Button>
        <div className="flex items-center gap-2">
          <span className="flex items-center gap-1 font-bold text-primary-foreground">
            <span className="text-primary">🔥</span> LUCKY WOLF
          </span>
        ...
        <div className="hidden items-center gap-4 md:flex">
          <Button variant="ghost" className="rounded-full bg-primary/10 px-4 text-primary-foreground">
            <span className="mr-1 text-primary">🏆</span> Sport
          </Button>
          <Button variant="ghost" className="rounded-full bg-background-secondary px-4 text-primary-foreground">
      ...
      <div className="flex items-center gap-4">
        <div className="relative hidden md:block">
          ...
          <Input
            placeholder="Search"
            className="h-9 w-64 rounded-full bg-background-secondary pl-9 text-primary-foreground"
          />
        </div>
        <Button
          variant="ghost"
